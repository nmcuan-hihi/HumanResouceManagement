      ...
      <View style={styles.container}>
        <NavigationContainer>
          <Stack.Navigator initialRouteName="Login">
            <Stack.Screen
              name="DangKyNghi"
              component={DangKyNghiScreen}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="DuyetNghiPhep"
              component={DuyetNghiPhep}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="ChiTietNghiPhep"
              component={ChiTietNghiPhep}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="MesengerDetails"
              component={MesengerDetails}
              options={{ headerShown: false }}
            />

            <Stack.Screen
              name="LoginCongTy"
              component={LoginCongTy}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="ThongTinChamCong"
              component={ThongTinChamCong}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="Login"
            ...
            <Stack.Screen
              ...
              component={DanhSachBangCap}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="DetailBangCap"
              component={DetailBangCap}
              options={{ headerShown: false }}
            />

            <Stack.Screen
              name="QuanLyMucLuong"
              component={QuanLyMucLuong}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="DanhSachLuong"
              component={DanhSachLuong}
              options={{ headerShown: false }}
            />

            <Stack.Screen
              name="ChiTietBangLuong"
            ...
            <Stack.Screen
              name="cccd"
              component={CccdScreen}
              options={{ headerShown: false }}
            />

            <Stack.Screen
              name="EditMatKhau"
              component={EditMatKhau}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="ThemBangCapNV"
              component={ThemBangCapNV}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="ThemSkillNV"
              component={ThemSkillNV}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="DetailBangCapNV"
              component={DetailBangCapNhanVien}
              options={{ headerShown: false }}
            />

            <Stack.Screen
              name="ListThietBi"
              component={ListThietBi}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="ChiTietThietBi"
              component={ChiTietThietBi}
              options={{ headerShown: false }}
            />
            <Stack.Screen
              name="SuaThietBi"
