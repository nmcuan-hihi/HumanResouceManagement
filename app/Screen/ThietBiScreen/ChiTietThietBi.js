...
import { getThietBiById, deleteThietBi } from "../../services/thietBicongty";
import { getEmployeeById } from "../../services/EmployeeFireBase";
import { get } from "react-native/Libraries/TurboModule/TurboModuleRegistry";
import { useFocusEffect } from "@react-navigation/native";

export default function ChiTietBangCap({ navigation, route }) {
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              await deleteThietBi(id);
              navigation.goBack();

              Alert.alert("Thông báo", "Xóa thành công");
            } catch (error) {
              Alert.alert("Lỗi", "Hiện tại không thể xóa");
            }
          },
        },
      ],
      ...
      <SafeAreaView style={styles.container}>
        <View style={{ height: 100 }}>
          <BackNav
            ...
            btn={"Sửa"}
            onEditPress={() => {
              navigation.navigate("SuaThietBi", { id: id });
            }}
          />
        </View>
